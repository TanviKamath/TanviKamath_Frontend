...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-lemon-bg via-white to-peach-bg">
      {/* Background Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className="absolute -top-1/4 -left-1/4 w-1/2 h-1/2 bg-orange-bg rounded-full blur-3xl"
        />
        <motion.div
          animate={{
            scale: [1, 1.3, 1],
          ...
          className="absolute -bottom-1/4 -right-1/4 w-1/2 h-1/2 bg-lime-bg rounded-full blur-3xl"
        />
      </div>
      ...
      >
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 md:p-10 border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              type="submit"
              className="w-full h-12 rounded-xl bg-primary hover:bg-primary/90 text-white font-semibold text-base shadow-lg hover:shadow-xl transition-all"
            >
              Sign In
            </Button>
          </form>
